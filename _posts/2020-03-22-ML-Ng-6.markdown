...
- However, when you test your hypothesis on a new set of houses, you find that it makes unacceptably large errors in its predictions. What shoud you try next?
  
    - Get more training examples
        - Try smaller sets of features
        - Try getting additional features
        - Try adding polynominal features $(x_1^2,\ x_2^2,\ x_1x_2,\ \text{etc.})$
...
- Our decision process can be broken down as follows:
    - **Getting more training exampls:** Fixes high variance
