...
#### 2.2 Perception Learning Algorithm (PLA)
...
- Perceptron Learning Algorithm
    ...
    - For $t = 0, 1, \dots$
        ...
        - find a mistake of $\mathbf{w}_t$ called $(x_{n(t)}, y_{n(t)})$, $\text{sign}\left( \mathbf{w}_t^T\mathbf{x}_{n(t)} \right) \ne y_{n(t)}$ 
...
- PLA fact: $\mathbf{w}_t$ gets more aligned with $\mathbf{w}_f$ 
    ...
    - by updating with any $(\mathbf{x}_{n(t)}, y_{n(t)})$,
        $$
        \begin{aligned}
